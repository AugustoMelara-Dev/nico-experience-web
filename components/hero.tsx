...
export default function Hero() {
  ...
  return (
    <section className="relative isolate flex min-h-[42rem] items-center overflow-hidden [--primary:var(--brand-gold)] [--primary-foreground:var(--brand-navy)]">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-[color:var(--brand-navy)] via-[color:var(--brand-navy)]/90 to-[color:var(--brand-navy)]/25" />
      <div className="absolute inset-0 bg-linear-to-t from-background via-transparent to-transparent" />
      <div className="absolute inset-0 bg-[color:var(--brand-navy)]/20 sm:hidden" />
      ...
      <div className="relative mx-auto w-full max-w-(--breakpoint-xl) px-4 py-24 md:px-8 md:py-32">
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            <h1 className="max-w-2xl text-pretty text-4xl font-medium leading-[1.02] tracking-tighter sm:text-5xl md:text-6xl">
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full bg-background/92 sm:w-auto"
            >
